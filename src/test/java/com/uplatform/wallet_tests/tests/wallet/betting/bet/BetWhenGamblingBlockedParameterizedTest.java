...
class BetWhenGamblingBlockedParameterizedTest extends BaseParameterizedTest {
    ...
    void shouldAllowBetWhenOnlyGamblingIsBlocked(NatsBettingCouponType couponType, String description) {
