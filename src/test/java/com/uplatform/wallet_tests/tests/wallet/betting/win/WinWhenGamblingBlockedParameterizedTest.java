...
class WinWhenGamblingBlockedParameterizedTest extends BaseParameterizedTest {
    ...
    void shouldProcessWinWhenOnlyGamblingIsBlocked(NatsBettingCouponType couponType, String description) {
