 ...
 * на одиночную ставку (SingleBetLimit) при совершении ставок в казино.
 *
 * <p>Данный параметризованный тест проверяет корректность обработки запросов
 * на совершение ставок, превышающих установленный лимит на одиночную ставку.
 ...
 * установленный лимит на одиночную ставку.</p>
 *
 * <p>Тест предварительно настраивает лимит на одиночную ставку для игрока через Public API
...
class BetWhenSingleBetLimitParametrizedTest extends BaseParameterizedTest {
    ...
    private final BigDecimal exceededBetAmount = new BigDecimal("100.00");
