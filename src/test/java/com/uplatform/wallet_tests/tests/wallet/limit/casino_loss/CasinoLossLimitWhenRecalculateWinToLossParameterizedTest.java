...
/**
 * Проверяет корректность перерасчета лимита CasinoLossLimit после последовательных операций
 * BET - WIN - LOSS (recalculated) при ставке через iframe.
 * Итоговые значения лимита должны соответствовать случаю обычного проигрыша.
 *
 * <p><b>Сценарий теста:</b></p>
 * <ol>
 *   <li><b>Регистрация игрока.</b></li>
 *   <li><b>Установка лимита.</b></li>
 *   <li><b>Совершение ставки и получение выигрыша.</b></li>
 *   <li><b>Перерасчет результата на проигрыш.</b></li>
 *   <li><b>Проверка события NATS и агрегата Redis.</b></li>
 * </ol>
 *
 ...
 *   <li>NATS: limit_changed_v2, recalculated_from_iframe.</li>
...
class CasinoLossLimitWhenRecalculateWinToLossParameterizedTest extends BaseParameterizedTest {
    ...
    @DisplayName("Перерасчет CasinoLossLimit: WIN -> LOSS")
    void shouldRecalculateCasinoLossLimitFromWinToLoss(NatsLimitIntervalType periodType) {
