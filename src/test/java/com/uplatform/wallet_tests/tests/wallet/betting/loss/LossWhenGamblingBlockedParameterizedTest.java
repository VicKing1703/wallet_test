...
class LossWhenGamblingBlockedParameterizedTest extends BaseParameterizedTest {
    ...
    void shouldProcessLossWhenOnlyGamblingIsBlocked(NatsBettingCouponType couponType, String description) {
