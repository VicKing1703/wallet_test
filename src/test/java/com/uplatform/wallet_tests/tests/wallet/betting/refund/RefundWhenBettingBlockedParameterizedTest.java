...
class RefundWhenBettingBlockedParameterizedTest extends BaseParameterizedTest {

    static Stream<Arguments> couponProvider() {
        return Stream.of(
                Arguments.of(NatsBettingCouponType.SINGLE, "Рефанд при заблокированном беттинге с купоном SINGLE"),
                Arguments.of(NatsBettingCouponType.EXPRESS, "Рефанд при заблокированном беттинге с купоном EXPRESS"),
                Arguments.of(NatsBettingCouponType.SYSTEM, "Рефанд при заблокированном беттинге с купоном SYSTEM")
        );
    }
    ...
    void shouldProcessRefundWhenBettingIsBlocked(NatsBettingCouponType couponType, String description) {
